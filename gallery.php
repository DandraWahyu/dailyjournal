...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt->bind_param("sssss", $judul, $tanggal, $gambar, $username, $id);
        $simpan = $stmt->execute();

    } else {
		    //jika tidak ada id, lakukan insert data baru
        $stmt = $conn->prepare("INSERT INTO gallery (judul,tanggal,gambar,username)
                                VALUES (?,?,?,?)");

        $stmt->bind_param("ssss", $judul, $tanggal, $gambar, $username);
        $simpan = $stmt->execute();
    }
